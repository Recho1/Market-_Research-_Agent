...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0f] grid-bg flex items-center justify-center z-50 p-4">

      {/* Background glow */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-96 h-96 rounded-full bg-[#00ff88]/3 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="w-12 h-12 mx-auto rounded-2xl bg-[#00ff88]/10 border border-[#00ff88]/20 flex items-center justify-center mb-3 signal-glow">
            <span
              className="text-lg font-bold text-[#00ff88] signal-glow-text"
          ...
          <h1
            className="text-xl font-bold text-[#e8e8f0] mb-0.5"
            style={{ fontFamily: "Syne,sans-serif" }}
          >
            ARIA
          </h1>
          <p className="text-[11px] text-[#505070] font-mono">
            Advanced Research & Intelligence Agent
          </p>
        </div>

        {/* Card */}
        <div className="bg-[#0d0d14] border border-[#1e1e2e] rounded-2xl p-5 shadow-2xl shadow-black/50">
          ...
          {step === 1 ? (
            ...
            <>
              ...
              <input
                ...
                autoFocus
                className="w-full bg-[#111118] border border-[#1e1e2e] rounded-xl px-4 py-3 text-sm text-[#e8e8f0] placeholder-[#303050] outline-none focus:border-[#00ff88]/30 transition-all"
              />
              ...
              <button
                onClick={handleStep1}
                disabled={!name.trim()}
                className="w-full mt-4 py-3 rounded-xl bg-[#00ff88]/10 border border-[#00ff88]/25 text-sm font-semibold text-[#00ff88] hover:bg-[#00ff88]/18 hover:border-[#00ff88]/40 transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                style={{ fontFamily: "Syne,sans-serif" }}
              >
                Continue →
              </button>
            ...
            <>
              <div className="flex items-center gap-2 mb-4">
                <button
                  ...
                  className="text-[10px] font-mono text-[#505070] hover:text-[#e8e8f0] transition-colors"
                >
                  ← back
                </button>
                <h2
                  className="text-sm font-bold text-[#e8e8f0]"
                  style={{ fontFamily: "Syne,sans-serif" }}
                >
              ...
              {/* Two column layout for role + industry side by side */}
